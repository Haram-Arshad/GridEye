...
def run_smote_pipeline(input_path: str, output_path: str):
    print("\n" + "=" * 50)
    print("  GridEye — SMOTE Balancing Pipeline (v2)")
    print("=" * 50 + "\n")
...
if __name__ == "__main__":
    ...
    # ── UPDATED: ab v2 (cleaned + augmented) dataset se balance hoga ──
    INPUT_PATH  = os.path.join(BASE_DIR, "augmented_dataset_v2.csv")
    OUTPUT_PATH = os.path.join(BASE_DIR, "balanced_data_final_v2.csv")
