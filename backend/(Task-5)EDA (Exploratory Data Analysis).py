...
# Relative File Paths (Aap ke project folder ke sath aligned)
BASE_DIR       = os.path.dirname(os.path.abspath(__file__))
# EDA ab REAL (imbalanced) cleaned data par chalti hai, SMOTE-balanced par nahi.
# (SMOTE se 50/50 ban jata hai, is liye class-distribution plot balanced data par
#  bemani hota hai.)
BALANCED_PATH  = os.path.join(BASE_DIR, "dataset_cleaned.csv")   # Task-2 output
# Missing-values heatmap RAW dataset se banta hai (imputation se pehle),
# warna hamesha 0% missing dikhata hai.
AUGMENTED_PATH = os.path.join(BASE_DIR, "dataset.csv")
OUTPUT_FOLDER  = os.path.join(BASE_DIR, "EDA_Outputs")
...
def run_eda(balanced_path: str, augmented_path: str, output_folder: str):
    ...
    print("=" * 50)
    print("LOADING CLEANED DATASET (real class imbalance)")
    print("=" * 50)
